...
#define CS_SET(xxx)  do{HAL_GPIO_WritePin(GPIOA, GPIO_PIN_2, (xxx));}while(0)
#define RST_SET(xxx)  do{HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, (xxx));}while(0)
#define XDCS_SET(xxx)  do{HAL_GPIO_WritePin(GPIOA, GPIO_PIN_3, (xxx));}while(0)
#define DREQ  HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_10)
